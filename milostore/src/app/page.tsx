...
import CategorySelector from "@/components/SelectorCategoriasHome/SelectorCategoriasHome";
...
export default function Home() {
  return (
    <div className="min-h-screen pt-[80px] md:pt-[120px]" >
      ...
      <div className="w-full max-w-[1500px] mx-auto flex flex-col items-center gap-4 justify-center my-12">
        <h2 style={{ fontFamily: 'Cheque, sans-serif' }} className="text-3xl text-center md:text-5xl font-bold text-[#1A1A1A] tracking-widest">Explorar por categoria</h2>
        <CategorySelector/>
      </div>
    </div>
  );
