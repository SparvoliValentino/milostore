                ...
                <div className="hidden md:block w-full">
                    <nav className="w-full">
                        <ul className="w-full flex justify-evenly items-center">
                            ...
                            <Link href="/ultimosIngresos"><h2 className={`${archivoBlack.className} text-outline text-[10px] md:text-[30px] text-[#1A1A1A] hover:border-b-black hover:border-b-2`}>Ultimos ingresos</h2></Link>
                ...
                {menuOpen && (
                    <>
                        ...
                        <div className="fixed top-0 right-0 w-[250px] h-full bg-[#FFDCF8] shadow-lg p-6 flex flex-col gap-6 z-50 transition-transform duration-300">
                            ...
                            <Link href="/ultimosIngresos" className={`${archivoBlack.className} text-outline text-[30px] text-[#1A1A1A] hover:border-b-black hover:border-b-2`} onClick={toggleMenu}>Últimos ingresos</Link>
